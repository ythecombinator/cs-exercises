...
const questions = ['Qual o montante inicial? (R$)', 'Qual a taxa de juros? (%/mês)'];
...
const printResult = answers => {
	const [amount, rate] = answers;
	const results = calcSavingsIncome(parseInitialAmount(amount), 6, rate);
